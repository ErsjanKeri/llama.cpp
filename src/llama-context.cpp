...
llm_graph_params llama_context::graph_params(
    ...
    return {
        ...
        /*.uring_projection_overlap=*/ model.uring_projection_overlap,
        /*.uring_async_projection_overlap=*/ model.uring_async_projection_overlap,
        /*.uring_async_experts=*/ model.uring_async_experts,
